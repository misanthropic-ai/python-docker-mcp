...
@pytest.mark.asyncio
async def test_install_package_transient_alt(docker_manager, mock_docker_client, mock_container):
    """Test installing a package in a transient container (alternative)."""
